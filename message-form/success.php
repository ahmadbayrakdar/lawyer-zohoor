...
<head>
    ...
    <link href="../css/message-form.css" rel="stylesheet" />
    ...
    <section>
        <div class="container-fluid errorMessage">
            <div class="heading_container">
                <h2>
                    <?php
                    echo $texts['message-form']['success'];
                    ?>
                </h2>
            </div>
            <div>
                <a href="../index.php?lang=<?php echo $lang ?>" class="slider-link">
                    <?php
                    echo $texts['message-form']['back'];
                    ?>
                </a>
            </div>
        </div>
